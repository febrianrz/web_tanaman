				...
				<form method="POST" action="" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
						<div class="form-group">
							...
							<div class="col-md-10 col-sm-10 col-xs-12">
								<input type="text" name="nama" id="first-name" required="required" class="form-control col-md-7 col-xs-12" autocomplete="off" autofocus="true" value="" required="required">
							</div>
						...
						<div class="form-group">
							...
							<div class="col-md-10 col-sm-10 col-xs-12">
								<input type="email" name="email" id="first-name" required="required" class="form-control col-md-7 col-xs-12" autocomplete="off" autofocus="true" value="" required="required">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-10 col-sm-10 col-xs-12">
								<input type="text" name="password" id="first-name" required="required" class="form-control col-md-7 col-xs-12" autocomplete="off" autofocus="true" value="" required="required">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="radio" name="status" id="status" value="Aktif" checked="checked"> Aktif &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
